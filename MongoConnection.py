...
class App_mongo_connect:
    ...
    def get_update_table(self):
        threecommasbots_db= self.db.threeCommasBots.find({"is_enabled": False, "account_id": 27977007})
    ...
    def get_bot_data(self,bot_ids_with_new_pairs):
        ...
        active_bots = self.db.threeCommasBots.find({"is_enabled": False, "account_id": 27977007}, {'_id': False})
